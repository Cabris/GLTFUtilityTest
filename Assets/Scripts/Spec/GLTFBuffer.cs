...
namespace Siccity.GLTFUtility
{
    ...
    public class GLTFBuffer
    {
        ...
        public async Task<ImportResult> Import(string filepath, byte[] bytefile, long binChunkStart)
        {
            ...
            if (uri == null)
            {
                ...
                else
                {
                    ...
                    {
                        throw new Exception("Import asset at [" + filepath + "] failed, code: " + request.responseCode);
                    }
                }
        ...
        public class ImportTask : Importer.ImportTask<ImportResult[]>
        {
            ...
            public ImportTask(List<GLTFBuffer> buffers, string filepath, byte[] bytefile, long binChunkStart) : base()
            {
                task = new Task(async () =>
                {
                    ...
                    {
                        Result[i] = await buffers[i].Import(filepath, bytefile, binChunkStart);
                    }
                });
            }
        }
